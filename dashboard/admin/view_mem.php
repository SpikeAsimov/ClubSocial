		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-10 p-3">
					<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="view_mem.php">Clientes</a></li>
											...
											while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
												...
												if (mysqli_affected_rows($con) == 1) {
													while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
														...
														echo "<td><form action='read_member.php' method='post' class='m-2'><input type='hidden' name='name' value='" . $uid . "'/><input type='submit' id='button1' value='Ver Historia ' class='btn btn-success btn-sm'/></form><form action='edit_member.php' method='post'><input type='hidden'  name='name' value='" . $uid . "'/><input type='submit' id='button1' value='Editar' class='btn btn-info btn-sm'/></form><form action='del_member.php' method='post' onsubmit='return ConfirmDelete()'><input type='hidden' name='name' value='" . $uid . "'/><input type='submit' value='Eliminar' width='20px' id='button1' class='btn btn-danger btn-sm'/></form></td></tr>";
														$msgid = 0;
													}
												}
											}
